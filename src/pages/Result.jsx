...
const Result = () => {
  ...
  return (
    ...
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
      <input onChange={e=> setInput(e.target.value)} value={input} className='flex-1 bg-transparent outline-none ml-8 mx-sm:w-20 placeholder-color' type="text" placeholder='Describe what you want to generate' />
